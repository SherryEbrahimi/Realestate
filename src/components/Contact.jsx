...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3b9442bb-95a3-4147-ac16-1429b2334458");
  ...
  return (
    ...
    overflow-hidden' id='Contact'>
      ...
      text-center'> Contact <span className='underline underline-offset-4 decoration-1 under font-light'> With Us</span></h1>
...
<form onSubmit={onSubmit} className=' max-w-2xl mx-auto text-gray-600 pt-8'>
  < div className='flex flex-wrap'>
    ...
    px-4 mt-2' type='Text' name='Name' placegolder='Your Name' required/>
    </div>

    <div className='w-full md:w-1/2 text-left md:pl-4'> Your Email
    <input className='w-full border border-gray-300 rounded py-3
    px-4 mt-2' type='Email' name='Email' placegolder='Your Email' required></input>
  ...
  <button className='bg-gray-600 text-white py-2 px-12 mb-10
