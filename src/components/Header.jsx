  ...
  return (
    ...
    items-center w-full overflow-hidden' style={{backgroundImage: "url('/header_img.png')"} } id='Header'>
      ...
      lg:px-32 text-white'>
        ...
        max-w-3xl font-sembold pt-20'> Explore homes that fit your dreams</h2>
<div className='space-x-6 mt-16'>
  <a href="#Projects" className='border border-white px-8 py-3 rounded'> Projects</a>
  <a href="#Contact" className='bg-gray-500 border border-white px-8 py-3 rounded'> Contact Us</a>
</div>
</motion.div>
    </div>
  )
